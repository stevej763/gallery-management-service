...
@ConfigurationPropertiesScan("com.steve.gallery.gallerymanagementservice.configuration.mongo")
@Configuration
    ...
    private MongoClient createMongoClient() {
        ...
        MongoClientSettings.Builder clientSettingsBuilder =
                MongoClientSettings
                        ...
                        .applicationName(mongoConfigurationContext.getApplicationName());
